#    جميع الحقوق لمطوري سورس ميرو حصريا لهم فقط
...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب ميرو  🐍", data="deploy")],
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("كروب المساعدة ❓", "https://t.me/jdvjxvkedvdSupport")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @jdvjxvkedvd", alert=True)
